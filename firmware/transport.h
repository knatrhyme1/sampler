...
// фазу (docs/known-issues.md, п. 1). Теперь отрисовка на ядре 1 сдвинуть
...
class Transport : public AudioSource {
 ...
 private:
  ...
  // дрейф темпа: на 137 BPM шаг ровно 7007,30 сэмпла, и округление вниз
  // уводит сетку на ~2,6 мс за каждую минуту (на 16 кГц), и уход копится. Поэтому остаток от деления
