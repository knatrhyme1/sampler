...
// пока не звучат: мелодического инструмента в движке ещё нет (эпик 5,
// сэмпл на клавишах с изменением высоты). Сетка та же, что у
// степ-секвенсора: 16 шагов четвертями = 4 такта, поэтому ролл и драм-
// каналы видны на одной временной шкале в аранжировке.
#pragma once
